    ...
    <aside>
        ...
        <nav>
          <div class='menu-items'>
            <ul>
              <a href='home'><li <?php if($page == 'home'){echo 'class="active-menu"';}else{echo 'class="hvr-bounce-to-right"';}?>class="hvr-bounce-to-right"><img class="icon" src="icons/home.svg" width="25px" height="25px"><span class="menu-text">  HOME</span></li></a> <!-- For both account types -->
        ...
        <div class='logout'>
            <a href='auth/logout'><h4 class="logout-content">Log out!</h4></a>
        </div>
